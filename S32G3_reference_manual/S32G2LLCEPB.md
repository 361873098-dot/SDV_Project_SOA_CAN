...
## S32G2 LLCE Standard Firmware Product Brief
...
| 2.1. | LLCE Standard.........................................................3            |
| 2.2. | High-Level Architecture of the LLCE Firmware.....4                                 |
| 3.   | Supported Targets................................................................8 |
| 4.   | Quality, Standards Compliance and Testing Approach ......8                         |
...
S32G2 LLCE Standard Firmware Product Brief, Product Brief , Rev. 1.5 , 01/2022
...
NXP LLCE firmware can support advanced extensions created by NXP or by the customers.

- CAN frame authentication with HSE services
- CAN to CAN routing
- CAN to Ethernet and Ethernet to CAN routing
...
- Support for up to 1024 filters and 2000 message buffers
...
- o AUTOSAR drivers for CAN, LIN, FlexRay
- o Firmware binaries for the 4 cores (DTE, PPE\_RX, PPE\_TX, FRPE)
- o LLCE firmware user guide
- o LLCE host interface header files + data structures
- o Sample applications (CAN, LIN)
- o Quick Start Guide
- o Release notes
...
- LIN firmware behave like a master on the LIN bus
...
LLCE Firmware architecture for FlexRay
...
LLCE Firmware product is developed according to NXP Software Development Processes that are Automotive-SPICE, IATF16949 and ISO 9001 compliant.

LLCE Firmware Software (SW) Releases starting with Beta are accompanied by SW quality packages containing at minimum the following deliverables:

- -Requirements Specification and Traceability Matrix (features-design-code-test);
- -Test Specification;
- -Test Report;
- -Static Analysis Report (MISRA) Report;
...
Document Number: 1.5 Rev. 1.5 01/2022