...
#define DIO_IPW_AR_RELEASE_MINOR_VERSION_C     4
#define DIO_IPW_AR_RELEASE_REVISION_VERSION_C  0
#define DIO_IPW_SW_MAJOR_VERSION_C             4
#define DIO_IPW_SW_MINOR_VERSION_C             0
#define DIO_IPW_SW_PATCH_VERSION_C             2
/*=================================================================================================
*                                     FILE VERSION CHECKS
=================================================================================================*/
...
/* Check if Dio_Ipw source file and Siul2_Dio_Ip_Cfg header file are of the same Software version */
    ...
    /* SchM_Dio.h version check start */
        ...
        #error "AUTOSAR Version Numbers of Dio_Cfg.h and SchM_Dio.h are different"
    #endif
...
static Dio_LevelType Dio_Ipw_ReadChannelValue
(
...
)
{
    ...
    ChannelLevel = Dio_Ipw_ReadChannelValue(u8Siul2Instance, ChannelId);
    return ChannelLevel;
}
...
)
{
    ...
    *(Dio_LevelType*)(SIUL2_DIO_IP_GPDO_ADDR32(u8Siul2Instance, ChannelId)) = Level;
}
...
)
{
    ...
    (*(Dio_LevelType*)(SIUL2_DIO_IP_GPDO_ADDR32(u8Siul2Instance, ChannelId))) = ChannelLevel;
...
#ifdef DIO_SPLIT_PORTID_SUPPORT
    if (PortId >= 7)
    {
        PortId -= 1;
    }
...
{
    uint8 u8Siul2Instance;
    uint16 MaskAvailable;

    u8Siul2Instance = Dio_au8PortSiul2Instance[PortId];
    MaskAvailable = Mask & Dio_aAvailablePinsForWrite[PortId];
    ...
    Siul2_Dio_Ip_MaskedWritePins(u8Siul2Instance,
                                ...
                                Dio_Ipw_ReverseBits(MaskAvailable)
                                );
#else
    Siul2_Dio_Ip_MaskedWritePins(u8Siul2Instance,
                                PortId,
