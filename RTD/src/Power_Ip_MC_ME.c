...
#define POWER_IP_MC_ME_SW_PATCH_VERSION_C               2
...
*
*/
void Power_Ip_MC_ME_ConfigCoreCOFBClock(const Power_Ip_MC_ME_ModeConfigType * ModeConfigPtr, uint8 PartitionIndex)
{
...
*
*/
void Power_Ip_MC_ME_EnablePartitionClock(const Power_Ip_MC_ME_ModeConfigType * ModeConfigPtr, uint8 PartitionIndex)
{
    const Power_Ip_MC_ME_PartitionConfigType *TempPartitionConfig = NULL_PTR;
...
*
*/
void Power_Ip_MC_ME_DisablePartitionClock(const Power_Ip_MC_ME_ModeConfigType * ModeConfigPtr, uint8 PartitionIndex)
{
    const Power_Ip_MC_ME_PartitionConfigType *TempPartitionConfig = NULL_PTR;
...
*
*/
void Power_Ip_MC_ME_EnablePartitionOutputSafe(const Power_Ip_MC_ME_ModeConfigType * ModeConfigPtr, uint8 PartitionIndex)
{
    const Power_Ip_MC_ME_PartitionConfigType *TempPartitionConfig = NULL_PTR;
...
*
*/
void Power_Ip_MC_ME_DisablePartitionOutputSafe(const Power_Ip_MC_ME_ModeConfigType * ModeConfigPtr, uint8 PartitionIndex)
{
    const Power_Ip_MC_ME_PartitionConfigType *TempPartitionConfig = NULL_PTR;
    TempPartitionConfig = &(*ModeConfigPtr->ArrayPartitionConfigPtr)[PartitionIndex];
