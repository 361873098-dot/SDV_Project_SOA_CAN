...
#define SIUL2_DIO_IP_SW_MAJOR_VERSION_C              4
#define SIUL2_DIO_IP_SW_MINOR_VERSION_C              0
#define SIUL2_DIO_IP_SW_PATCH_VERSION_C              2
...
*                                          LOCAL MACROS
==================================================================================================*/
#define SIUL2_DIO_IP_NUM_OF_PIN_PORT_U16           ((uint16)16U)
...
uint32 Siul2_Dio_Ip_au32BaseAdresses[3] =
{
...
#else
uint32 Siul2_Dio_Ip_au32BaseAdresses[SIUL2_INSTANCE_COUNT] = IP_SIUL2_BASE_ADDRS;
#endif
...
)
{
    ...
    SIUL2_DIO_IP_DEV_ASSERT((boolean)(pin < SIUL2_DIO_IP_NUM_OF_PIN_PORT_U16));
