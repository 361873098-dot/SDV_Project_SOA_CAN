...
#define I2C_AR_RELEASE_MINOR_VERSION_C       4
...
#define I2C_SW_MAJOR_VERSION_C               4
#define I2C_SW_MINOR_VERSION_C               0
#define I2C_SW_PATCH_VERSION_C               2
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
/* Check if current file and I2c_Ipw.h header file are of the same Software version */
    ...
    /* Check if the source file and SchM_I2c.h header file are of the same Autosar version */
