...
void Power_Ip_CortexM_WarmReset(void)
{
    ...
    RegValue = IP_CM_AIRCR;
    RegValue &= ~(CM_AIRCR_VECTKEY_MASK32 | CM_AIRCR_SYSRESETREQ_MASK32);
    RegValue |= (CM_AIRCR_VECTKEY(CM_AIRCR_VECTKEY_KEY_U32) | CM_AIRCR_SYSRESETREQ_MASK32);

    IP_CM_AIRCR = RegValue;
