...
/* Check if Port_Ipw.c and Siul2_Port_Ip_TrustedFunctions.h are of the same vendor */
...
#endif
/* Check if Port_Ipw.c and Siul2_Port_Ip_TrustedFunctions.h are of the same Autosar version */
...
#endif
/* Check if Port_Ipw.c and Siul2_Port_Ip_TrustedFunctions.h are of the same software version */
