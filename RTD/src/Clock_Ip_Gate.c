...
#define CLOCK_IP_GATE_SW_PATCH_VERSION_C               2
...
#endif
#ifdef CLOCK_IP_MC_ME_PARTITION_COFB_ENABLE_REQUEST_WITHOUT_STAT
static void Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequestWithoutStat(Clock_Ip_GateConfigType const* Config);
static void Clock_Ip_ClockUpdateGateMcMePartitionCollectionClockRequestWithoutStat(Clock_Ip_NameType ClockName, boolean Gate);
#endif
...
static void Clock_Ip_ClockUpdateGateMcMePartitionCollectionClockRequestWithoutStat(Clock_Ip_NameType ClockName, boolean Gate)
{
    ...
    /* Write configuration to register */
    Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequestWithoutStat(&Config);
}
#endif
...
#ifdef CLOCK_IP_MC_ME_PARTITION_COFB_ENABLE_REQUEST_WITHOUT_STAT
    {
        Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequestWithoutStat,      /* Set */
        Clock_Ip_ClockUpdateGateMcMePartitionCollectionClockRequestWithoutStat,   /* Update */
    },
#endif
};
