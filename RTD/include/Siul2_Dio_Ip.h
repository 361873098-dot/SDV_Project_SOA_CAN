...
#define SIUL2_DIO_IP_SW_MAJOR_VERSION_H              4
#define SIUL2_DIO_IP_SW_MINOR_VERSION_H              0
#define SIUL2_DIO_IP_SW_PATCH_VERSION_H              2
...
#define  SIUL2_DIO_IP_PGPDO_OFFSET_U32         ((uint32)0x1700UL)
...
#define SIUL2_DIO_IP_PGPDO_ADDR32(PDAC_INDEX,PGPDO_INDEX)  (Siul2_Dio_Ip_au32BaseAdresses[PDAC_INDEX] + SIUL2_DIO_IP_PGPDO_OFFSET_U32 +             \
                                                            (((((PGPDO_INDEX / 2UL) + 1UL) * 2UL) - ((PGPDO_INDEX % 2UL) + 1UL)) << 1UL)            \
                                                           )
#else
#define SIUL2_DIO_IP_PGPDO_ADDR32(SIUL2_INSTANCE,PGPDO_INDEX)  (Siul2_Dio_Ip_au32BaseAdresses[SIUL2_INSTANCE] + SIUL2_DIO_IP_PGPDO_OFFSET_U32 +     \
                                                                (((((PGPDO_INDEX / 2UL) + 1UL) * 2UL) - ((PGPDO_INDEX % 2UL) + 1UL)) << 1UL)        \
                                                               )
#endif

#if (STD_ON == DIO_VIRTWRAPPER_SUPPORT)
#define SIUL2_DIO_IP_PGPDI_ADDR32(PDAC_INDEX,PGPDI_INDEX)  (Siul2_Dio_Ip_au32BaseAdresses[PDAC_INDEX] + SIUL2_DIO_IP_PGPDI_OFFSET_U32 +             \
...
#if (STD_ON == DIO_VIRTWRAPPER_SUPPORT)
extern uint32 Siul2_Dio_Ip_au32BaseAdresses[3];
#else
extern uint32 Siul2_Dio_Ip_au32BaseAdresses[SIUL2_INSTANCE_COUNT];
#endif
