...
#define DIO_IPW_AR_RELEASE_MINOR_VERSION_H     4
#define DIO_IPW_AR_RELEASE_REVISION_VERSION_H  0
#define DIO_IPW_SW_MAJOR_VERSION_H             4
#define DIO_IPW_SW_MINOR_VERSION_H             0
#define DIO_IPW_SW_PATCH_VERSION_H             2
...
#define DIO_IPW_PORTID_EXTRACT(ChannelId)     ((((ChannelId) >= 102)? ((ChannelId) + 16) : (ChannelId)) >> DIO_IPW_PORTID_SHIFT_U8)
#else
