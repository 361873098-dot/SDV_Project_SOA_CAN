...
#define I2C_TYPES_AR_RELEASE_MINOR_VERSION          4
#define I2C_TYPES_AR_RELEASE_REVISION_VERSION       0
#define I2C_TYPES_SW_MAJOR_VERSION                  4
#define I2C_TYPES_SW_MINOR_VERSION                  0
#define I2C_TYPES_SW_PATCH_VERSION                  2

/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and I2c_Ipw_Types.h header file are of the same vendor */
#if (I2C_TYPES_VENDOR_ID != I2C_IPW_TYPES_VENDOR_ID)
    #error "I2c_Types.h and I2c_Ipw_Types.h have different vendor ids"
#endif
/* Check if current file and I2c_Ipw_Types.h header file are of the same Autosar version */
...
#endif
/* Check if current file and I2c_Ipw_Types.h header file are of the same Software version */
...
#if (I2C_TYPES_VENDOR_ID != I2C_VENDOR_ID_CFGDEFINES)
    #error "I2c_Types.h and CDD_I2c_CfgDefines.h have different vendor ids"
#endif
/* Check if current file and CDD_I2c_CfgDefines.h header file are of the same Autosar version */
#if ((I2C_TYPES_AR_RELEASE_MAJOR_VERSION    != I2C_AR_RELEASE_MAJOR_VERSION_CFGDEFINES) ||    \
     (I2C_TYPES_AR_RELEASE_MINOR_VERSION    != I2C_AR_RELEASE_MINOR_VERSION_CFGDEFINES) ||    \
     (I2C_TYPES_AR_RELEASE_REVISION_VERSION != I2C_AR_RELEASE_REVISION_VERSION_CFGDEFINES)    \
    )
    #error "AutoSar Version Numbers of I2c_Types.h and CDD_I2c_CfgDefines.h are different"
#endif
/* Check if current file and CDD_I2c_CfgDefines.h header file are of the same Software version */
#if ((I2C_TYPES_SW_MAJOR_VERSION != I2C_SW_MAJOR_VERSION_CFGDEFINES) || \
     (I2C_TYPES_SW_MINOR_VERSION != I2C_SW_MINOR_VERSION_CFGDEFINES) || \
     (I2C_TYPES_SW_PATCH_VERSION != I2C_SW_PATCH_VERSION_CFGDEFINES)    \
    )
    #error "Software Version Numbers of I2c_Types.h and CDD_I2c_CfgDefines.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if current file and Mcal.h header file are of the same Autosar version */
    #if ((I2C_TYPES_AR_RELEASE_MAJOR_VERSION != MCAL_AR_RELEASE_MAJOR_VERSION) || \
         (I2C_TYPES_AR_RELEASE_MINOR_VERSION != MCAL_AR_RELEASE_MINOR_VERSION))
