...
#define POWER_IP_MC_RGM_SW_PATCH_VERSION                2
...
#define  Call_Power_Ip_MC_RGM_ModeConfig(MC_RGM_pModeConfigPtr, DomainIndex) \
    OsIf_Trusted_Call2params(Power_Ip_MC_RGM_ModeConfig,(MC_RGM_pModeConfigPtr),(DomainIndex))
#define  Call_Power_Ip_MC_RGM_CheckModeConfig(MC_RGM_pModeConfigPtr, DomainIndex) \
    OsIf_Trusted_Call2params(Power_Ip_MC_RGM_CheckModeConfig,(MC_RGM_pModeConfigPtr),(DomainIndex))
#define  Call_Power_Ip_MC_RGM_EnableResetDomain(MC_RGM_pModeConfigPtr, DomainIndex) \
    OsIf_Trusted_Call2params(Power_Ip_MC_RGM_EnableResetDomain,(MC_RGM_pModeConfigPtr),(DomainIndex))
#define  Call_Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr, DomainIndex) \
    OsIf_Trusted_Call2params(Power_Ip_MC_RGM_DisableResetDomain,(MC_RGM_pModeConfigPtr),(DomainIndex))

  #else /* (STD_OFF == POWER_IP_ENABLE_USER_MODE_SUPPORT) */

#define  Call_Power_Ip_MC_RGM_ModeConfig(MC_RGM_pModeConfigPtr, DomainIndex) \
    Power_Ip_MC_RGM_ModeConfig(MC_RGM_pModeConfigPtr, DomainIndex)
#define  Call_Power_Ip_MC_RGM_CheckModeConfig(MC_RGM_pModeConfigPtr, DomainIndex) \
    Power_Ip_MC_RGM_CheckModeConfig(MC_RGM_pModeConfigPtr, DomainIndex)
#define  Call_Power_Ip_MC_RGM_EnableResetDomain(MC_RGM_pModeConfigPtr, DomainIndex) \
    Power_Ip_MC_RGM_EnableResetDomain(MC_RGM_pModeConfigPtr, DomainIndex)
#define  Call_Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr, DomainIndex) \
    Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr, DomainIndex)
...
void Power_Ip_MC_RGM_ModeConfig(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
void Power_Ip_MC_RGM_CheckModeConfig(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
void Power_Ip_MC_RGM_EnableResetDomain(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
void Power_Ip_MC_RGM_DisableResetDomain(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
