...
#define SIUL2_PORT_IP_SW_MAJOR_VERSION_H              4
#define SIUL2_PORT_IP_SW_MINOR_VERSION_H              0
#define SIUL2_PORT_IP_SW_PATCH_VERSION_H              2
...
#ifdef SIUL2_PORT_IP_INIT_UNUSED_PIN
#if (STD_ON == SIUL2_PORT_IP_INIT_UNUSED_PIN)
    /* Check if the files Siul2_Port_Ip.h and Siul2_Port_Ip_UnusedPin.h are of the same version */
    #if (SIUL2_PORT_IP_VENDOR_ID_H != SIUL2_PORT_IP_VENDOR_ID_UNUSED_H)
        #error "Siul2_Port_Ip.h and Siul2_Port_Ip_UnusedPin.h have different vendor ids"
    #endif
    /* Check if Siul2_Port_Ip.h and Siul2_Port_Ip_UnusedPin.h are of the same Autosar version */
    #if ((SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_H    != SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_UNUSED_H) || \
         (SIUL2_PORT_IP_AR_RELEASE_MINOR_VERSION_H    != SIUL2_PORT_IP_AR_RELEASE_MINOR_VERSION_UNUSED_H) || \
         (SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_H != SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_UNUSED_H) \
        )
        #error "AutoSar Version Numbers of Siul2_Port_Ip.h and Siul2_Port_Ip_UnusedPin.h are different"
    #endif
    /* Check if Siul2_Port_Ip.h and Siul2_Port_Ip_UnusedPin.h are of the same Software version */
    #if ((SIUL2_PORT_IP_SW_MAJOR_VERSION_H != SIUL2_PORT_IP_SW_MAJOR_VERSION_UNUSED_H) || \
         (SIUL2_PORT_IP_SW_MINOR_VERSION_H != SIUL2_PORT_IP_SW_MINOR_VERSION_UNUSED_H) || \
         (SIUL2_PORT_IP_SW_PATCH_VERSION_H != SIUL2_PORT_IP_SW_PATCH_VERSION_UNUSED_H)    \
        )
        #error "Software Version Numbers of Siul2_Port_Ip.h and Siul2_Port_Ip_UnusedPin.h are different"
    #endif
#endif /* (STD_ON == SIUL2_PORT_IP_INIT_UNUSED_PIN) */
#endif /* (SIUL2_PORT_IP_INIT_UNUSED_PIN) */
