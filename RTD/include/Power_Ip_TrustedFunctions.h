 ...
 *
 */
extern void Power_Ip_MC_RGM_ModeConfig(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
 ...
 *
 */
extern void Power_Ip_MC_RGM_CheckModeConfig(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
 ...
 *
 */
extern void Power_Ip_MC_RGM_EnableResetDomain(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
 ...
 *
 */
extern void Power_Ip_MC_RGM_DisableResetDomain(const Power_Ip_MC_RGM_ModeConfigType * ModeConfigPtr, uint8 DomainIndex);
