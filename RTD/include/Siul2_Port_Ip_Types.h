...
#define SIUL2_PORT_IP_TYPES_SW_MAJOR_VERSION_H              4
#define SIUL2_PORT_IP_TYPES_SW_MINOR_VERSION_H              0
#define SIUL2_PORT_IP_TYPES_SW_PATCH_VERSION_H              2
...
#if (STD_ON == FEATURE_SIUL2_HAS_INPUT_HYSTERESYS)
/*!
...
#endif /* STD_ON == FEATURE_SIUL2_HAS_INPUT_HYSTERESYS */
...
#ifndef SIUL2_PORT_IP_S32ZSE_PLATFORM
typedef enum
{
...
} Siul2_Port_Ip_UnUsedPinConfigType;
