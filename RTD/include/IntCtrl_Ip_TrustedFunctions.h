...
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION                   2
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION           4
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION           4
...
/* Check if current file and IntCtrl_Ip_CfgDefines header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of IntCtrl_Ip_TrustedFunctions.h and IntCtrl_Ip_CfgDefines.h are different"
#endif
