...
#define DIO_SW_MAJOR_VERSION_CFG_C            4
...
{
    (Dio_PortLevelType)0xFBFF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xF7AF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0x003F,
    (Dio_PortLevelType)0x07FF,
    (Dio_PortLevelType)0x0000,
    (Dio_PortLevelType)0xAAAB,
    (Dio_PortLevelType)0xAAAA,
    (Dio_PortLevelType)0x7F36
};
