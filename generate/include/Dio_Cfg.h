...
#define DIO_SW_MAJOR_VERSION_CFG_H            4
#define DIO_SW_MINOR_VERSION_CFG_H            0
#define DIO_SW_PATCH_VERSION_CFG_H            2
...
*
*/
#define DioConf_DioChannel_DioChannel_0  ((uint16)0x0022U)
/* ---------- DioPort_1 ---------- */

/**
* @brief          Symbolic name for the port DioPort_1.
*/
#define DioConf_DioPort_DioPort_1  ((uint8)0x0aU)
/**
* @brief          Symbolic name for the channel VR5510_PWRON2.
*
*/
#define DioConf_DioChannel_VR5510_PWRON2  ((uint16)0x00a7U)
/* ---------- DioPort_2 ---------- */
...
/**
* @brief          Symbolic name for the channel IGN_KEY.
*
*/
