...
==================================================================================================*/
#define CDD_PLATFORM_SYSTEM_IP_CFG_VENDOR_ID                    43
#define CDD_PLATFORM_SYSTEM_IP_CFG_SW_MAJOR_VERSION                   4
#define CDD_PLATFORM_SYSTEM_IP_CFG_SW_MINOR_VERSION                   0
#define CDD_PLATFORM_SYSTEM_IP_CFG_SW_PATCH_VERSION                   2
#define CDD_PLATFORM_SYSTEM_IP_CFG_AR_RELEASE_MAJOR_VERSION           4
#define CDD_PLATFORM_SYSTEM_IP_CFG_AR_RELEASE_MINOR_VERSION           4
...
#if (CDD_PLATFORM_SYSTEM_IP_CFG_VENDOR_ID != CDD_PLATFORM_SYSTEM_IP_CFG_DEFINES_VENDOR_ID)
