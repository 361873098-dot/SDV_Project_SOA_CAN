...
#define FLEXCAN_IP_CFG_SW_MAJOR_VERSION_H               4
#define FLEXCAN_IP_CFG_SW_MINOR_VERSION_H               0
#define FLEXCAN_IP_CFG_SW_PATCH_VERSION_H               2
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
#define FLEXCAN_IP_ENABLE_USER_MODE_SUPPORT    (STD_OFF)
    ...
    #define FLEXCAN_IP_CTRL_REG_PROT_SUPPORT_U8    ((uint8)4U)
#endif
...
#define FLEXCAN_IP_FEATURE_HAS_SUPV    (STD_OFF)
...
#define FLEXCAN_IP_FEATURE_HAS_EXPANDABLE_MEMORY    (STD_ON)
...
#define FLEXCAN_IP_FEATURE_HAS_HR_TIMER    (STD_OFF)
    ...
    #define FLEXCAN_HRTIMERSRC_GMAC0_VALUE    (0U)
    #define FLEXCAN_HRTIMERSRC_STM7_VALUE    (1U)
    #define FLEXCAN_HRTIMERSRC_PFE_VALUE    (2U)
    #define FLEXCAN_HRTIMERSRC_VALUE0_VALUE    (3U)
    #define FLEXCAN_IP_HR_TIMESTAMP_SRC_SELECTABLE (STD_ON)
...
#define FLEXCAN_IP_FEATURE_MBDSR_COUNT    (4U)
